...
for (let i = 0; i < 10.; i++) {
    document.write(`<div>Enter</div>`);
}
// - За допомогою циклу for і document.write() вивести 10 блоків div c довільним текстом і індексом всередині
for (let i = 0; i < 10.; i++) {
    document.write(`<div>${i} - Enter</div>`);
}
// - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом всередині.
let x = 0;
while (x < 20) {
    document.write(`<h1>Halloo</h1>`);
    x++;
}
// - За допомогою циклу while вивести в документ 20 блоків h1 c довільним текстом і індексом всередині.
let w = 0;
while (w < 20) {
    document.write(`<h1>${w}_Hallo</h1>`);
    w++;
}
//
...
for (let i = 0; i < products.length; i++) {
    ...
    <h3 class="product-title">${products[i].title}.Price - ${products[i].price}</h3>
     <img src="${products[i].image}" alt="Малюнок" class="product-image">
    </div>`);
}
//
//
